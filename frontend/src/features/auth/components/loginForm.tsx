...
function Form() {
  ...
  return (
    <form
      ...
      className="border border-white w-full md:w-1/3 px-12 rounded-lg min-w-[340px] shadow-white shadow-xl/15"
    >
      <h1 className="text-3xl font-bold text-center my-10">Sign In</h1>
      <input
        {...register("username")}
        type="text"
        className="block border border-white w-[100%] text-xl text-white p-4 rounded-lg my-10"
