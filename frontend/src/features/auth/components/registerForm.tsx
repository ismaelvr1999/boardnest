...
function LoginForm() {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}  className="border border-white w-1/3 px-12 rounded-lg min-w-[340px]">
              <h1 className="text-2xl font-bold text-center my-5">Sign Up</h1>
              <input {...register("username",{required:true})} type="text" className="block border border-white w-[100%] text-sm text-[#B5B5B5] p-4 rounded-lg my-5" placeholder="Enter your username"/>
              <input {...register("firstName",{required:true})} type="text" className="block border border-white w-[100%] text-sm text-[#B5B5B5] p-4 rounded-lg my-5" placeholder="Enter your first Name"/>
              <input {...register("lastName",{required:true})} type="text" className="block border border-white w-[100%] text-sm text-[#B5B5B5] p-4 rounded-lg my-5" placeholder="Enter your last Name"/>              
